        ...
        <div v-else>
          <div v-for="link in links.data" :key="link.id" class="grid grid-cols-12 gap-4 px-6 py-4 hover:bg-slate-700/30">
            ...
            <div class="col-span-1 text-right">
              <button class="inline-flex items-center rounded-md bg-rose-600 px-3 py-1 text-sm font-medium text-white hover:bg-rose-500" @click.prevent="remove(link.id)">Remover</button>
            </div>

...
class StoreIntegrationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        if ($type === IntegrationType::EMAIL->value) {
            ...
            $rules['channel_token'] = ['required', 'string', 'max:500'];
    ...
    public function messages(): array
    {
        return [
            ...
            'token.required' => 'O token é obrigatório para este tipo de integração.',
            'user_token.required' => 'O token do usuário é obrigatório para este tipo de integração.',
            'channel_token.required' => 'O token do canal é obrigatório para este tipo de integração.',
        ];
    }
